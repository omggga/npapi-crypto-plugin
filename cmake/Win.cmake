...
set(MFC_PATH "..\\..\\libs\\winddk\\inc\\mfc42")
set(ATLLIBPATH "..\\..\\libs\\winddk")
set(VS14_ATL "C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC")
if (NOT ATL_INCLUDE_DIR)
    ...
    set(ATLLIB_GUESSES "${VS14_ATL}/atlmfc/lib" ${ATLLIB_GUESSES})
...
function (add_wix_installer PROJNAME WIX_SOURCEFILES WIX_COMPGROUP WIX_OUTDIR WIX_DLLFILES WIX_PROJDEP)
    if (WIN32 AND WIX_FOUND)
        ...
        configure_file(${FB_TEMPLATE_DEST_DIR}/fwh-chrome-manifest.json ${CMAKE_CURRENT_BINARY_DIR}/${PLUGIN_CRX_NATIVEHOST_NAME}_chrome.template)
        configure_file(${FB_TEMPLATE_DEST_DIR}/fwh-mozilla-manifest.json ${CMAKE_CURRENT_BINARY_DIR}/${PLUGIN_CRX_NATIVEHOST_NAME}_mozilla.template)
