...
#define GOSTE_SBOX_DEFAULT		GOSTE_SBOX_SC
...
ECGOST_sign_init (
	...
	int sboxID,		/* итентификатор параметров хэширования */
...
ECGOST_verify_init (
	...
	unsigned char *pub,	/* открытый ключ */
	int sboxID,		/* идентификатор параметров для хэширования */
	unsigned char *h0	/* начальный вектор хэширования */
	);
/*
 *	Хэширование данных
...
GOSTS_sign_init (
	...
	int paramsID,		/* идентификатор параметров ключа */
	OPAQUE_PRIV_KEY *x,	/* секретный ключ */
	int sboxID,		/* идентификатор параметров хэширования */
	unsigned char *h0,	/* начальный вектор хэширования */
	int flags
	);
/*
...
GOSTE_init (
	...
	int sboxID			/* идентификатор узлов замены */
	);
/*
...
PSE_pseudo_rand_init(
	...
	char *buf, 
	int *save, 
	int (WINAPI *rand_callback)(int,int,int,char *), 
	char *userdata
	);
/*
